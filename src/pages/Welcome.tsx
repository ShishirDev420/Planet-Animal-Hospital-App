...
import { signInWithPopup, GoogleAuthProvider, signInWithEmailAndPassword, createUserWithEmailAndPassword, sendPasswordResetEmail, getAdditionalUserInfo } from 'firebase/auth';
    ...
    try {
      ...
      if (isSignUp) {
        if (!details?.isNewUser) {
          await auth.signOut();
          setAuthError("Hey, a user already exists with this Google account. Please sign in instead.");
          return;
        }
