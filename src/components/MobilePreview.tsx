...
function Iphone16ProFrame({ url }: { url: string }) {
  return (
    <>
      <div className="absolute -inset-4 rounded-[3.8rem] bg-gradient-to-br from-white/16 via-white/3 to-black/55 p-px shadow-[0_55px_150px_rgba(0,0,0,0.88)]">
        <div className="h-full w-full rounded-[3.75rem] bg-[#111]" />
      </div>

      <div className="relative mx-auto h-[852px] w-[393px] rounded-[3.6rem] border-[9px] border-[#1a1a1a] bg-[#101010] shadow-[inset_0_0_0_1.5px_rgba(255,255,255,0.08),0_36px_110px_rgba(0,0,0,0.72)]">
        <div className="absolute inset-[4px] rounded-[3.1rem] border border-white/10 pointer-events-none z-30" />
        <div className="absolute left-1/2 top-[10px] z-40 flex h-[28px] w-[122px] -translate-x-1/2 items-center justify-center rounded-full bg-black shadow-[0_2px_10px_rgba(0,0,0,0.6)]">
          <div className="mr-2.5 h-[9px] w-[9px] rounded-full bg-slate-800 shadow-[inset_0_0_3px_rgba(255,255,255,0.22)]" />
          <div className="h-[6px] w-[44px] rounded-full bg-slate-900" />
        </div>

        <div className="absolute -left-[13px] top-[130px] h-[38px] w-[4px] rounded-l-lg bg-[#2a2a2a]" />
        <div className="absolute -left-[13px] top-[198px] h-[68px] w-[4px] rounded-l-lg bg-[#2a2a2a]" />
        <div className="absolute -left-[13px] top-[282px] h-[68px] w-[4px] rounded-l-lg bg-[#2a2a2a]" />
        <div className="absolute -right-[13px] top-[224px] h-[98px] w-[4px] rounded-r-lg bg-[#2a2a2a]" />
...
function Iphone16ProMaxFrame({ url }: { url: string }) {
  return (
    <>
